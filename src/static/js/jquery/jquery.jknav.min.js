...
down:"j",name:"default",easing:"swing",speed:"normal",circular:true,reevaluate:false},TARGET:a.browser.mozilla?"html":"body",init:function(d){var b=a.extend(a.extend({},a.jknav.default_options),d);a.jknav.index[b.name]=null;a(a.jknav.TARGET).keyup(function(c){j(c,b)})}}})(jQuery);
